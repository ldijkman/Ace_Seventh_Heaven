      ...
      (function initConsoleLogDiv() {
        ...
        var logTo = (function createLogDiv() {
          ...
          document.getElementById("legend").innerHTML = 'Console test hmm only shows editor log, Drag Me. <input type="button" onclick=\'document.getElementById("console-log-text").innerHTML="Cleared Console";\' value="Clear" title="Empty Console!"> <input type="button" value="hide" title="Not yet!">';
